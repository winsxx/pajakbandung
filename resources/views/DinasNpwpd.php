...
<div class="header_bg"><!-- start header -->
	<div class="container">
		...
		<nav class="navbar" role="navigation">
		  <div class="container-fluid">
		    ...
		    <div class="navbar-header">
		      ...
		      <a class="navbar-brand" href="index.html"><img src="../../public/images/logo.png" alt="" class="img-responsive"/> </a>
		    </div>
		    <div class="title"><h2> Dinas Pelayanan Pajak Kota Bandung </h2></div>
		    <!-- Collect the nav links, forms, and other content for toggling -->
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      <ul class="menu nav navbar-right navbar-nav ">
		        <li class="active"><a href="DinasHome.php">beranda</a></li>
		        <li><a href="#.php">pengaturan</a></li>
		...
		<ol class="breadcrumb">
		  <li><a href="DinasHome.php">Beranda</a></li>
